...
///////////////////
    ...
    if ( ! function_exists( 'dco_theme_setup' ) ) :
        function dco_theme_setup(){
            ...
            //And Add our stylesheets
         
            add_action('wp_enqueue_scripts', 'dco_add_script_and_styles'); // Enqueue some scripts we'll be needing
            function dco_add_script_and_styles() {
                if ( is_admin() )  return;
                wp_deregister_script( 'jquery' ); // remove the pre-installed version of jquery
